...
Description:
Implements the BaseProvider interface to query AbuseIPDB. Dedicated exclusively to 
IPv4 lookups, it extracts the community-driven abuse confidence score, ISP, and 
country data, translating varying score thresholds into categorized risk verdicts.
"""
